...
async function fetchApartments() {
  ...
  return [
    { id: '1', name: 'Cozy Studio near University A', location: 'University Avenue', price: 150000, bedrooms: 1, bathrooms: 1, isNewListing: true,
      ...
      petPolicy: 'No Pets', furnishingStatus: 'Unfurnished', leaseTerm: 'Long-Term',
    ...
    { id: '2', name: 'Spacious 2-Bedroom near Tech Campus', location: 'Innovation Hub', price: 280000, bedrooms: 2, bathrooms: 2, isNewListing: false,
      ...
      petPolicy: 'Pet-Friendly', furnishingStatus: 'Furnished', leaseTerm: 'Long-Term',
    ...
    { id: '3', name: 'Modern Loft in Downtown', location: 'City Center', price: 200000, bedrooms: 1, bathrooms: 1, isNewListing: true,
      ...
      petPolicy: 'Small Pets Only', furnishingStatus: 'Semi-Furnished', leaseTerm: 'Monthly',
    ...
    { id: '4', name: 'Affordable Room in Shared House', location: 'Student District', price: 80000, bedrooms: 1, bathrooms: 0, isNewListing: false,
      ...
      petPolicy: 'No Pets', furnishingStatus: 'Furnished', leaseTerm: 'Long-Term',
      buildingAmenities: [],
      propertyFeatures: [],
      proximity: ['Near Schools', 'Near Public Transport'],
    ...
    { id: '5', name: 'Bright 3-Bedroom Family Home', location: 'Quiet Suburb', price: 350000, bedrooms: 3, bathrooms: 2, isNewListing: false,
      ...
      petPolicy: 'Pet-Friendly', furnishingStatus: 'Unfurnished', leaseTerm: 'Long-Term',
    ...
    { id: '6', name: 'Compact Studio near Arts College', location: 'Bohemian Quarter', price: 120000, bedrooms: 1, bathrooms: 1, isNewListing: true,
      ...
      petPolicy: 'No Pets', furnishingStatus: 'Furnished', leaseTerm: 'Monthly',
      buildingAmenities: [],
      propertyFeatures: [],
      proximity: ['Near Markets/Supermarkets'],
      accessibilityFeatures: [],
    ...
    { id: '8', name: 'Executive 2-Bedroom Apartment', location: 'Business District', price: 400000, bedrooms: 2, bathrooms: 2, isNewListing: false,
      ...
      petPolicy: 'No Pets', furnishingStatus: 'Semi-Furnished', leaseTerm: 'Long-Term',
    ...
    { id: '9', name: 'Quaint 1-Bedroom Cottage', location: 'Riverside Village', price: 100000, bedrooms: 1, bathrooms: 1, isNewListing: false,
      ...
      petPolicy: 'Pet-Friendly', furnishingStatus: 'Unfurnished', leaseTerm: 'Short-Term',
      buildingAmenities: [],
    ...
    { id: '11', name: 'Spacious 5-Bedroom Villa', location: 'Quiet Suburb', price: 800000, bedrooms: 5, bathrooms: 4, isNewListing: false,
      ...
      petPolicy: 'Pet-Friendly', furnishingStatus: 'Semi-Furnished', leaseTerm: 'Long-Term',
      buildingAmenities: ['Pool', 'Security Cameras', 'Generator', 'Concierge Service'],
    ...
    { id: '12', name: 'Compact 1-Bedroom Flat', location: 'Student District', price: 95000, bedrooms: 1, bathrooms: 1, isNewListing: false,
      ...
      petPolicy: 'No Pets', furnishingStatus: 'Unfurnished', leaseTerm: 'Monthly',
      buildingAmenities: [],
      propertyFeatures: [],
      proximity: ['Near Schools', 'Near Public Transport'],
      accessibilityFeatures: ['Elevator Access'],
  ...
  return (
    <div className="map-view-container">
      ...
      <p className="map-view-description">
        This section will feature an advanced interactive map with capabilities like:
      </p>
      <ul className="map-features-list">
        <li><span className="map-feature-icon">✏️</span> **Drawing Tool:** Define custom search areas on the map.</li>
        <li><span className="map-feature-icon">📍</span> **Points of Interest (POI):** Display nearby schools, hospitals, parks, and public transport.</li>
        <li><span className="map-feature-icon">🔥</span> **Heatmap:** Visualize areas with high apartment density or average prices.</li>
      </ul>
      <img
      ...
      />
      <p className="map-view-note">Full map integration requires a dedicated map library and significant development. This is a conceptual view.</p>
    </div>
  );
};
...
const CompareModal = ({ apartments, onClose }) => {
            ...
            <div className="compare-modal-overlay show" onClick={onClose}>
                <div className="compare-modal-content" onClick={(e) => e.stopPropagation()}>
                    <div className="compare-modal-header">
                        ...
                        <button className="compare-modal-close-button" onClick={onClose}>&#x2715;</button>
                    </div>
    ...
    return (
        <div className="compare-modal-overlay show" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="compare-modal-title">
            <div className="compare-modal-content" onClick={(e) => e.stopPropagation()}>
                <div className="compare-modal-header">
                    <h3 id="compare-modal-title">Compare Apartments ({apartments.length} selected)</h3>
                    <button className="compare-modal-close-button" onClick={onClose} aria-label="Close comparison view">
                        &#x2715;
                    </button>
                </div>
                <div className="compare-grid">
                    {apartments.map(apt => (
                        <div key={apt.id} className="compare-card">
                            <img src={apt.images[0]} alt={apt.name} className="compare-image" />
                            <h4 className="compare-card-title">{apt.name}</h4>
                            <p className="compare-card-price">₦{apt.price.toLocaleString()}/month</p>
                            <ul className="compare-features-list">
                                ...
                                {apt.furnishingStatus && <li>🛋️ Furnishing: {apt.furnishingStatus}</li>}
                                ...
                                {apt.accessibilityFeatures && apt.accessibilityFeatures.length > 0 && (
                                    <li>♿ Accessibility: {apt.accessibilityFeatures.join(', ')}</li>
                                )}
                ...
                <p className="compare-note">This is a conceptual comparison tool. Full implementation would allow more detailed side-by-side analysis.</p>
            </div>
        </div>
    );
};
...
const RentalApplicationModal = ({ apartmentName, onClose }) => {
    ...
    return (
        <div className="application-modal-overlay show" onClick={onClose} role="dialog" aria-modal="true" aria-labelledby="application-modal-title">
            <div className="application-modal-content" onClick={(e) => e.stopPropagation()}>
                <div className="application-modal-header">
                    ...
                    <button className="application-modal-close-button" onClick={onClose} aria-label="Close application form">
                        &#x2715;
                    </button>
                </div>
                {submitSuccess ? (
                    ...
                    <form onSubmit={handleSubmit} className="application-form">
                        <p className="application-intro">Please fill out the form below to submit your rental application. You can also upload required documents.</p>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input type="email" id="contactEmail" className="form-input" required />
                        </div>
                        <div className="form-group">
                            <label htmlFor="contactPhone">Phone Number:</label>
                            <input type="tel" id="contactPhone" className="form-input" required />
                        </div>
                        <div className="form-group">
                            <label htmlFor="incomeProof">Proof of Income (e.g., Pay Stubs, Bank Statement):</label>
                            <input type="file" id="incomeProof" className="form-input-file" accept=".pdf,.doc,.docx,.jpg,.png" />
                            <p className="file-instruction">Max file size: 5MB. Supported formats: PDF, DOC, DOCX, JPG, PNG.</p>
                        </div>
                        <div className="form-group">
                            <label htmlFor="idProof">Government ID (e.g., Passport, Driver's License):</label>
                            <input type="file" id="idProof" className="form-input-file" accept=".pdf,.jpg,.png" />
                            <p className="file-instruction">Max file size: 5MB. Supported formats: PDF, JPG, PNG.</p>
                        </div>
                        <div className="form-group">
                            <label htmlFor="references">References (Optional):</label>
                            <textarea id="references" rows="3" className="form-textarea" placeholder="Provide names and contact info for references..."></textarea>
                        </div>
                        {submitError && <p className="application-error-message">{submitError}</p>}
                        <button type="submit" className="application-submit-button" disabled={isSubmitting}>
                            {isSubmitting ? 'Submitting...' : 'Submit Application'}
                        </button>
                        <p className="application-note">Note: This is a conceptual application form. In a real application, data would be securely processed.</p>
                    </form>
                )}
            </div>
        </div>
...
export default function DiscoverPage() {
  ...
  const [accessibilityFeaturesFilter, setAccessibilityFeaturesFilter] = useState([]);
  ...
  const [userAvatar, setUserAvatar] = useState('https://placehold.co/40x40/cccccc/ffffff?text=U');
  ...
  const toggleCompare = useCallback((apartment) => {
    setApartmentsToCompare(prevCompare => {
      if (prevCompare.some(apt => apt.id === apartment.id)) {
        ...
        if (prevCompare.length < 3) { // Limit comparison to 3 apartments
  ...
  const applyFiltersAndSort = useCallback((apartmentsToFilter = allApartments, currentMinPrice = minPrice, currentMaxPrice = maxPrice) => {
    ...
    if (currentPage === 'bookmarks') {
        ...
        if (petPolicyFilter !== 'any') {
            updatedApartments = updatedApartments.filter(apt => apt.petPolicy === petPolicyFilter);
        }
        if (furnishingStatusFilter !== 'any') {
            updatedApartments = updatedApartments.filter(apt => apt.furnishingStatus === furnishingStatusFilter);
        }
        if (leaseTermFilter !== 'any') {
            updatedApartments = updatedApartments.filter(apt => apt.leaseTerm === leaseTermFilter);
        }
        if (buildingAmenitiesFilter.length > 0) {
            updatedApartments = updatedApartments.filter(apt =>
                buildingAmenitiesFilter.every(amenity => apt.buildingAmenities && apt.buildingAmenities.includes(amenity))
            );
        }
        if (propertyFeaturesFilter.length > 0) {
            updatedApartments = updatedApartments.filter(apt =>
                propertyFeaturesFilter.every(feature => apt.propertyFeatures && apt.propertyFeatures.includes(feature))
            );
        }
        if (proximityFilter !== 'any') {
            updatedApartments = updatedApartments.filter(apt => apt.proximity && apt.proximity.includes(proximityFilter));
        }
        if (accessibilityFeaturesFilter.length > 0) {
            updatedApartments = updatedApartments.filter(apt =>
                accessibilityFeaturesFilter.every(feature => apt.accessibilityFeatures && apt.accessibilityFeatures.includes(feature))
            );
        }
    }
  ...
  }, [allApartments, searchTerm, minPrice, maxPrice, bedroomsFilter, bathroomsFilter, isNewListingFilter, locationFilter, propertyTypeFilter, amenitiesFilter, datePostedFilter, bookmarkedApartments, currentPage, petPolicyFilter, furnishingStatusFilter, leaseTermFilter, buildingAmenitiesFilter, propertyFeaturesFilter, proximityFilter, accessibilityFeaturesFilter, sortBy]);


  // Effect to re-apply filters and sort when filter/sort states change
  useEffect(() => {
    applyFiltersAndSort();
  }, [applyFiltersAndSort, searchTerm, minPrice, maxPrice, bedroomsFilter, bathroomsFilter, isNewListingFilter, locationFilter, propertyTypeFilter, amenitiesFilter, datePostedFilter, sortBy, bookmarkedApartments, currentPage, petPolicyFilter, furnishingStatusFilter, leaseTermFilter, buildingAmenitiesFilter, propertyFeaturesFilter, proximityFilter, accessibilityFeaturesFilter]);
  ...
  const availableAmenities = ['WiFi', 'Parking', 'Gym', 'Pool', 'Garden', 'Security', 'Pet-Friendly']; // General amenities
  const availableBuildingAmenities = ['24/7 Electricity', 'Borehole Water', 'Generator', 'Elevator', 'Security Cameras', 'Concierge Service'];
  const availablePropertyFeatures = ['Balcony', 'Ensuite Bathroom', 'Walk-in Closet', 'Study Room', 'Maid\'s Room'];
  const availableProximityOptions = ['Near Schools', 'Near Hospitals', 'Near Public Transport', 'Near Markets/Supermarkets'];
  const availableAccessibilityFeatures = ['Wheelchair Accessible', 'Ground Floor', 'Elevator Access'];
  ...
  const ApartmentDetailsView = ({ apartment, onClose, onBackToListings, isMobileView, onContactAgentClick, onToggleBookmark, isBookmarked, onApplyNowClick }) => {
        ...
        <div className={isMobileView ? "apartment-details-page-content" : "apartment-details-modal-content"}
          ...
          <div className="apartment-details-info">
            ...
            <div className="advanced-details-grid">
                {apartment.petPolicy && <div className="detail-item"><strong>Pet Policy:</strong> {apartment.petPolicy}</div>}
                {apartment.furnishingStatus && <div className="detail-item"><strong>Furnishing:</strong> {apartment.furnishingStatus}</div>}
                {apartment.leaseTerm && <div className="detail-item"><strong>Lease Term:</strong> {apartment.leaseTerm}</div>}
            </div>

            {/* Amenities List */}
            {(apartment.amenities && apartment.amenities.length > 0) || (apartment.buildingAmenities && apartment.buildingAmenities.length > 0) ? (
                <div className="apartment-amenities">
                    <h4>Amenities:</h4>
                    <ul>
                        {apartment.amenities && apartment.amenities.map((amenity, index) => (
                        ...
                        {apartment.buildingAmenities && apartment.buildingAmenities.map((amenity, index) => (
            ...
            {apartment.propertyFeatures && apartment.propertyFeatures.length > 0 && (
            ...
            {(apartment.proximity && apartment.proximity.length > 0) || (apartment.accessibilityFeatures && apartment.accessibilityFeatures.length > 0) ? (
                <div className="apartment-additional-info">
                    {apartment.proximity && apartment.proximity.length > 0 && (
                        <div>
                            <h4>Proximity:</h4>
                            <ul>
                                {apartment.proximity.map((item, index) => <li key={`proximity-${index}`}>🗺️ {item}</li>)}
                            </ul>
                        </div>
                    )}
                    {apartment.accessibilityFeatures && apartment.accessibilityFeatures.length > 0 && (
                        <div>
                            <h4>Accessibility:</h4>
                            <ul>
                                {apartment.accessibilityFeatures.map((item, index) => <li key={`access-${index}`}>♿ {item}</li>)}
                            </ul>
                        </div>
                    )}
                </div>
            ...
            {(apartment.virtualTourUrl || apartment.videoTourUrl) && (
                <div className="tour-buttons">
                    {apartment.virtualTourUrl && (
                        <a href={apartment.virtualTourUrl} target="_blank" rel="noopener noreferrer" className="tour-button">
                            View 3D Virtual Tour
                        </a>
                    )}
                    {apartment.videoTourUrl && (
                        <a href={apartment.videoTourUrl} target="_blank" rel="noopener noreferrer" className="tour-button">
            ...
            <div className="action-buttons-group">
                ...
                <button className="apartment-details-apply-button" onClick={onApplyNowClick}>Apply Now</button>
            </div>

            {/* Reviews Section (Conceptual) */}
            <div className="reviews-section">
                <h4>Reviews & Ratings (Conceptual)</h4>
                <p className="reviews-placeholder">This section will display user reviews and ratings for this property. You can leave your own review after a viewing or stay.</p>
            ...
            <div className="similar-apartments-section">
                ...
                <p className="similar-apartments-placeholder">Based on your preferences and this listing, here are some other apartments you might like.</p>
                {/* In a real app, this would be a carousel or grid of similar apartment cards */}
                <div className="similar-apartments-grid">
                    <div className="similar-card">
                        <img src="https://placehold.co/150x100/F0F4F8/333333?text=Similar+Apt+1" alt="Similar Apartment 1" />
                        <p>Studio in Downtown</p>
                        <p>₦180,000/month</p>
                    </div>
                    <div className="similar-card">
                        <img src="https://placehold.co/150x100/E8EEF2/333333?text=Similar+Apt+2" alt="Similar Apartment 2" />
                        <p>1 Bed near Park</p>
                        <p>₦220,000/month</p>
                    </div>
                </div>
                <p className="similar-apartments-note">This feature uses a recommendation engine to suggest relevant listings.</p>
            </div>
  ...
  return (
    <>
        ...
        <div className={`app-container ${isSidebarCollapsed ? 'sidebar-collapsed-mode' : ''}`}>
          <style>{`
            ...
            * {
            ...
            .filter-toggle-button, .map-view-button, .compare-button-main {
            ...
            .filter-toggle-button .filter-icon, .map-view-button .map-icon, .compare-button-main .compare-icon {
              width: 20px;
              height: 20px;
              fill: currentColor;
            }
            .filter-toggle-button:hover, .map-view-button:hover, .compare-button-main:hover {
            ...
            .compare-card-button.selected {
                background-color: #FF7043; /* Accent color when selected */
            }
            .compare-card-button.selected:hover {
            ...
            .filter-modal-content {
              ...
              padding: 25px;
              width: 90%;
              max-width: 500px; /* Increased max-width for more filters */
            ...
            .clear-filters-button, .apply-filters-button, .save-search-button {
              padding: 10px 18px;
              border-radius: var(--border-radius-md);
              border: none;
              cursor: pointer;
            ...
            .apartment-amenities, .apartment-features, .apartment-additional-info {
                margin-top: 15px;
                margin-bottom: 25px;
                background-color: var(--bg-main);
                padding: 15px;
            ...
            .apartment-amenities h4, .apartment-features h4, .apartment-additional-info h4 {
                font-size: 1.1em;
                color: var(--text-dark);
                margin-bottom: 10px;
            }
            .apartment-amenities ul, .apartment-features ul, .apartment-additional-info ul {
                list-style: none;
                padding: 0;
                display: grid;
            ...
            .apartment-amenities li, .apartment-features li, .apartment-additional-info li {
                display: flex;
                align-items: center;
                font-size: 0.95em;
                color: var(--text-medium);
            ...
            .apartment-details-contact-button, .apartment-details-apply-button {
              background-color: var(--primary-color);
              color: white;
              padding: 12px 25px;
              border-radius: var(--border-radius-md);
            ...
            .apartment-details-contact-button:hover, .apartment-details-apply-button:hover {
              background-color: var(--primary-dark);
              transform: translateY(-2px);
              box-shadow: 0 4px 12px var(--shadow-medium);
            }
            .apartment-details-apply-button {
                background-color: var(--accent-color); /* Different color for apply button */
            }
            .apartment-details-apply-button:hover {
                background-color: #E65100;
            }

            .reviews-section, .similar-apartments-section {
                background-color: var(--bg-main);
                padding: 20px;
                border-radius: var(--border-radius-md);
                border: 1px solid var(--border-light);
            ...
            .reviews-section h4, .similar-apartments-section h4 {
                font-size: 1.1em;
                color: var(--text-dark);
                margin-bottom: 10px;
            }
            .reviews-placeholder, .similar-apartments-placeholder, .similar-apartments-note {
                font-size: 0.9em;
                color: var(--text-medium);
                margin-bottom: 15px;
                line-height: 1.6;
            ...
            .compare-modal-overlay.show .compare-modal-content {
                transform: translateY(0);
                opacity: 1;
            }
            ...
            /* --- Rental Application Modal Styles --- */
            ...
            .application-modal-overlay.show .application-modal-content {
                transform: translateY(0);
                opacity: 1;
            }
            ...
            @media (max-width: 640px) {
                ...
                .application-success-message, .application-error-message {
                    font-size: 0.9em;
                }
                .application-note {
                    font-size: 0.7em;
          ...
          <header className="responsive-header">
            ...
            <div className="nav-user-status" onClick={() => setShowUserDropdown(!showUserDropdown)} ref={userDropdownRef}>
              ...
              <div className={`user-dropdown ${showUserDropdown ? 'show' : ''}`}>
                {isLoggedIn ? (
                  <>
                    <a href="#" className="user-dropdown-item" onClick={() => { setCurrentPage('profile'); setShowUserDropdown(false); }}>Profile</a>
                    <a href="#" className="user-dropdown-item" onClick={() => { setCurrentPage('dashboard'); setShowUserDropdown(false); }}>Dashboard</a>
                    <a href="#" className="user-dropdown-item" onClick={() => { setCurrentPage('saved-searches'); setShowUserDropdown(false); }}>Saved Searches</a> {/* New Link */}
          ...
          <aside className="app-sidebar">
            ...
            <div className="nav-links">
              ...
              <a href="#" className={`nav-link ${currentPage === 'saved-searches' ? 'active' : ''}`} onClick={() => {
                setCurrentPage('saved-searches');
              }}>
                <span className="icon">💾</span> <span className="link-text">Saved Searches</span>
              </a>
              <a href="#" className={`nav-link ${currentPage === 'profile' ? 'active' : ''}`} onClick={() => {
                setCurrentPage('profile');
              }}>
                <span className="icon">👤</span> <span className="link-text">Profile</span>
              </a>
              <a href="#" className={`nav-link ${currentPage === 'dashboard' ? 'active' : ''}`} onClick={() => {
                setCurrentPage('dashboard');
              }}>
                <span className="icon">📊</span> <span className="link-text">Dashboard</span>
              </a>
          ...
          <main className="main-content">
            ...
            <div className="controls-section">
              <div className="search-bar-container">
                ...
                >
                    <svg className="compare-icon" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                {filteredApartments.map((apartment, index) => (
                  ...
                  >
                      ...
                      <div className="card-content">
                        ...
                        >View Details</button>
                        <button
                            className={`compare-card-button ${apartmentsToCompare.some(apt => apt.id === apartment.id) ? 'selected' : ''}`}
                            onClick={() => toggleCompare(apartment)}
                            disabled={apartmentsToCompare.length >=3 && !apartmentsToCompare.some(apt => apt.id === apartment.id)}
                        >
                            {apartmentsToCompare.some(apt => apt.id === apartment.id) ? 'Remove from Compare' : 'Add to Compare'}
                        </button>
                      </div>
                    </div>
                ))}
          ...
          <div className={`filter-modal-overlay ${showFiltersModal ? 'show' : ''}`} onClick={() => setShowFiltersModal(false)}
            ...
            <div className={`filter-modal-content ${showFiltersModal ? 'show' : ''}`} onClick={(e) => e.stopPropagation()}>
              ...
              <div className="filter-modal-body">
                ...
                <div className="filter-group">
                    ...
                    <div className="amenities-checkbox-grid">
                        {availableAmenities.map(amenity => (
                            <div key={`gen-amenity-${amenity}`} className="filter-checkbox-group">
                                <input
                                    type="checkbox"
                                ...
                                />
                                <label htmlFor={`gen-amenity-${amenity}`} className="filter-label">{amenity}</label>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="filter-group">
                    ...
                    <div className="amenities-checkbox-grid">
                        {availableBuildingAmenities.map(amenity => (
                            <div key={`bldg-amenity-${amenity}`} className="filter-checkbox-group">
                                <input
                                    type="checkbox"
                                    ...
                                    className="filter-checkbox"
                                />
                                <label htmlFor={`bldg-amenity-${amenity}`} className="filter-label">{amenity}</label>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="filter-group">
                    ...
                    <div className="amenities-checkbox-grid">
                        {availablePropertyFeatures.map(feature => (
                            <div key={`prop-feature-${feature}`} className="filter-checkbox-group">
                                <input
                                    type="checkbox"
                                    ...
                                    className="filter-checkbox"
                                />
                                <label htmlFor={`prop-feature-${feature}`} className="filter-label">{feature}</label>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="filter-group">
                    <label htmlFor="modalPetPolicy" className="filter-label">Pet Policy:</label>
                    <select
                        id="modalPetPolicy"
                ...
                <div className="filter-group">
                    <label htmlFor="modalFurnishingStatus" className="filter-label">Furnishing Status:</label>
                    <select
                ...
                <div className="filter-group">
                    <label htmlFor="modalLeaseTerm" className="filter-label">Lease Term:</label>
                    <select
                        id="modalLeaseTerm"
                ...
                <div className="filter-group">
                    <label htmlFor="modalProximity" className="filter-label">Proximity To:</label>
                    <select
                        id="modalProximity"
                ...
                <div className="filter-group">
                    ...
                    <div className="amenities-checkbox-grid">
                        {availableAccessibilityFeatures.map(feature => (
                            <div key={`access-feature-${feature}`} className="filter-checkbox-group">
                                <input
                                    type="checkbox"
                                    ...
                                    className="filter-checkbox"
                                />
                                <label htmlFor={`access-feature-${feature}`} className="filter-label">{feature}</label>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <button className="save-search-button" onClick={() => {
                    alert('Search criteria saved! You will receive alerts for new matching listings. (Conceptual Feature)');
          ...
          <div className={`mobile-menu-overlay ${showMobileMenu ? 'show' : ''}`} onClick={() => setShowMobileMenu(false)}>
            <div className={`mobile-menu-content ${showMobileMenu ? 'show' : ''}`} onClick={(e) => e.stopPropagation()}>
              ...
              <div className="mobile-nav-links">
                ...
                <a href="#" className={`mobile-nav-link ${currentPage === 'saved-searches' ? 'active' : ''}`} onClick={() => {
                  setShowMobileMenu(false);
                  setCurrentPage('saved-searches');
                  alert('This would navigate to your saved searches dashboard. (Conceptual Feature)');
                }}>
                  <span className="icon">💾</span> Saved Searches
                </a>
                <a href="#" className={`mobile-nav-link ${currentPage === 'profile' ? 'active' : ''}`} onClick={() => {
                  setShowMobileMenu(false);
                  setCurrentPage('profile');
                  alert('This would navigate to your user profile. (Conceptual Feature)');
                }}>
                  <span className="icon">👤</span> Profile
                </a>
                <a href="#" className={`mobile-nav-link ${currentPage === 'dashboard' ? 'active' : ''}`} onClick={() => {
                  setShowMobileMenu(false);
                  setCurrentPage('dashboard');
                  alert('This would navigate to your user dashboard. (Conceptual Feature)');
                }}>
              ...
              <div className="mobile-nav-user-actions">
                {isLoggedIn ? (
                  <>
                    <button onClick={() => { setShowMobileMenu(false); setCurrentPage('profile'); alert('This would navigate to your user profile. (Conceptual Feature)'); }}>Profile</button>
                    <button onClick={() => { setShowMobileMenu(false); setCurrentPage('dashboard'); alert('This would navigate to your user dashboard. (Conceptual Feature)'); }}>Dashboard</button>
      ...
      {/* Placeholder for Saved Searches Page */}
      {currentPage === 'saved-searches' && (
        <div className="map-view-container"> {/* Reusing map-view-container styles for a simple placeholder */}
            <button className="map-view-back-button" onClick={() => setCurrentPage('list')}>
                &larr; Back to Discover
            </button>
            <h3 className="map-view-title">Your Saved Searches (Conceptual)</h3>
            <p className="map-view-description">
                This page would display your saved search criteria and alert you to new matching listings.
            </p>
            <p className="map-view-note">Manage your alerts and preferences here.</p>
        </div>
      )}
      ...
      {currentPage === 'profile' && (
        <div className="map-view-container">
            ...
            <h3 className="map-view-title">User Profile (Conceptual)</h3>
            <p className="map-view-description">
                This page would allow you to view and edit your profile information, manage preferences, etc.
            </p>
            <p className="map-view-note">A personalized space for your account details.</p>
        </div>
      )}

      {/* Placeholder for User Dashboard Page */}
      {currentPage === 'dashboard' && (
        <div className="map-view-container">
            <button className="map-view-back-button" onClick={() => setCurrentPage('list')}>
                &larr; Back to Discover
            </button>
            <h3 className="map-view-title">User Dashboard (Conceptual)</h3>
            <p className="map-view-description">
                This dashboard would provide an overview of your activity, including viewing appointments, application status, and communications.
            </p>
            <p className="map-view-note">Your central hub for managing your Lodger experience.</p>
        </div>
      )}
